document.addEventListener("DOMContentLoaded", function () {
  ...
  const toggle =
    ...
    document.querySelector(".icon-btn.sidebar-toggle") ||
  ...
  navItems.forEach((item) => {
    ...
    if (item.tagName === "A") {
      ...
      try {
        ...
        if (
          ...
          window.location.href.startsWith(resolvedHref) ||
        ...
        try {
          if (
            lastSegment &&
            (window.location.pathname.endsWith(lastSegment) ||
              window.location.href.indexOf(norm) !== -1)
          ) {
            item.classList.add("active");
          }
        } catch (err2) {
    ...
    if (
      item.dataset.route &&
      window.location.pathname.endsWith(item.dataset.route)
    ) {
      item.classList.add("active");
    }
  ...
  if (searchInput) {
    document.addEventListener("keydown", function (e) {
      ...
      if (
        ...
        if (pill) pill.classList.add("focus");
      }
    });
    ...
    searchInput.addEventListener("blur", function () {
      const pill = searchInput.closest(".search-pill");
      if (pill) pill.classList.remove("focus");
    });
  }
  ...
  const translations = {
    hi: {
      ...
      "Admin Dashboard – AI Grievance Portal":
        "एडमिन डैशबोर्ड – एआई शिकायत पोर्टल",
      "Citizen Login – AI Grievance Portal": "नागरिक लॉगिन – एआई शिकायत पोर्टल",
      "Register – AI Grievance Portal": "रजिस्टर – एआई शिकायत पोर्टल",
      "Forgot Password – AI Grievance Portal":
        "पासवर्ड भूल गए – एआई शिकायत पोर्टल",
      "Complaint History – AI Grievance Portal":
        "शिकायत इतिहास – एआई शिकायत पोर्टल",
      "Lodge New Grievance – AI Grievance Portal":
        "नई शिकायत दर्ज करें – एआई शिकायत पोर्टल",
      "User Dashboard – AI Grievance Portal":
        "उपयोगकर्ता डैशबोर्ड – एआई शिकायत पोर्टल",
      "User Profile – AI Grievance Portal":
        "उपयोगकर्ता प्रोफ़ाइल – एआई शिकायत पोर्टल",
      ...
      Security: "सुरक्षा",
      "Review details, update status, and reassign the department if needed.":
        "विवरण की समीक्षा करें, स्थिति अपडेट करें, और आवश्यक होने पर विभाग को पुनः सौंपें।",
      "Review incoming grievances, track critical alerts, and monitor resolution performance.":
        "आगामी शिकायतों की समीक्षा करें, महत्वपूर्ण अलर्ट ट्रैक करें, और समाधान प्रदर्शन की निगरानी करें।",
      "Smart complaint routing": "स्मार्ट शिकायत मार्गदर्शन",
      "Track your grievances, review status updates, and lodge new issues without delay.":
        "अपनी शिकायतों को ट्रैक करें, स्थिति अपडेट देखें, और बिना देरी के नए मुद्दे दर्ज करें।",
      "Your grievance has been submitted successfully.":
        "आपकी शिकायत सफलतापूर्वक सबमिट हो गई है।",
      "AI identifies the right department instantly so citizens don't waste time finding the correct channel.":
        "एआई तुरंत सही विभाग की पहचान करता है ताकि नागरिकों को सही चैनल खोजने में समय बर्बाद न होना पड़े।",
      "AI is helping to assign the right department automatically.":
        "एआई सही विभाग को स्वचालित रूप से असाइन करने में मदद कर रहा है।",
      "AI routing reduced reassignment delays in July.":
        "एआई मार्गदर्शन ने जुलाई में पुनः असाइनमेंट देरी को कम किया।",
      "Field team has been notified and will inspect the site today.":
        "फील्ड टीम को सूचित किया गया है और वह आज साइट का निरीक्षण करेगी।",
      ...
      "Contact our helpdesk if you need assistance with filing your grievance.":
        "अपनी शिकायत दर्ज करने में सहायता चाहिए तो हमारी हेल्पडेस्क से संपर्क करें।",
      ...
      "Designed for inclusive urban grievance management.":
        "समावेशी शहरी शिकायत प्रबंधन के लिए डिज़ाइन किया गया।",
      "Dismiss alert": "अलर्ट बंद करें",
      "Don't have an account?": "क्या आपका खाता नहीं है?",
      "Don�t have an account?": "क्या आपका खाता नहीं है?",
      "General Services": "सामान्य सेवाएं",
      "Latest updates with status and department assignment.":
        "स्थिति और विभाग असाइनमेंट के साथ नवीनतम अपडेट।",
      ...
      "Search by complaint ID, title or department...":
        "शिकायत आईडी, शीर्षक या विभाग द्वारा खोजें...",
      "Search history by title or ID...":
        "शीर्षक या आईडी द्वारा इतिहास खोजें...",
      "Register now": "अब रजिस्टर करें",
      "Remembered your password?": "क्या आपने अपना पासवर्ड याद कर लिया है?",
      "Save Updates": "अपडेट सहेजें",
      "Review details, update status, and reassign the department if needed.":
        "विवरण की समीक्षा करें, स्थिति अपडेट करें, और आवश्यक होने पर विभाग को पुनः सौंपें।",
      "Search by complaint title or ID...":
        "शिकायत शीर्षक या आईडी द्वारा खोजें...",
      "Select language": "भाषा चुनें",
      "My Account": "मेरा खाता",
      "Search grievances, departments, status...":
        "शिकायतें, विभाग, स्थिति खोजें...",
      "Search grievances, users, departments...":
        "शिकायतें, उपयोगकर्ता, विभाग खोजें...",
      "Search complaints...": "शिकायतों में खोजें...",
      ...
      "Search by complaint ID, title or resident...":
        "शिकायत आईडी, शीर्षक या निवासी द्वारा खोजें...",
      "Quick action search": "त्वरित खोज",
      "Accessibility support available for all citizens.":
        "सभी नागरिकों के लिए पहुंच समर्थन उपलब्ध।",
      "Helpline: 1800-123-4567 | Email: support@aigrievance.gov.in":
        "हेल्पलाइन: 1800-123-4567 | ईमेल: support@aigrievance.gov.in",
      "Citizen-friendly grievance lodging": "नागरिक-अनुकूल शिकायत पंजीकरण",
      ...
      "Filter, review, and assign grievances across all city departments.":
        "सभी शहर विभागों में शिकायतों को फ़िल्टर, समीक्षा और असाइन करें।",
      Filters: "फ़िल्टर",
      ...
      "Keep track of department workload and complaint statuses.":
        "विभागीय कार्यभार और शिकायत की स्थिति पर नज़र रखें।",
      Action: "कार्रवाई",
      View: "देखें",
      ...
      "Explore department performance, grievance categories, and monthly trends.":
        "विभाग के प्रदर्शन, शिकायत श्रेणियों और मासिक रुझानों का अन्वेषण करें।",
      "Key insights": "मुख्य अंतर्दृष्टियाँ",
      "Sanitation team resolved 28% more cases this month":
        "स्वच्छता टीम ने इस महीने 28% अधिक मामले हल किए",
      "Focus on rapid response helped clear backlog faster.":
        "त्वरित प्रतिक्रिया पर ध्यान देने से बकाया काम तेजी से साफ़ हुआ।",
      "Water supply complaints account for 24% of total volume":
        "जल आपूर्ति शिकायतें कुल मात्रा का 24% बनाती हैं",
      "Works department is prioritizing leak detection and repair.":
        "कार्य विभाग रिसाव का पता लगाने और मरम्मत को प्राथमिकता दे रहा है।",
      "Average resolution stable at 3.8 days":
        "औसत समाधान 3.8 दिनों पर स्थिर है",
      "Grievance analytics and performance reporting":
        "शिकायत विश्लेषण और प्रदर्शन रिपोर्टिंग",
      "Departments directory": "विभाग निर्देशिका",
      "View department leads, active workloads, and pending complaint counts.":
        "विभाग प्रमुखों, सक्रिय कार्यभार, और लंबित शिकायत गणना देखें।",
      ...
      "Manage user accounts and check complaint activity across the portal.":
        "उपयोगकर्ता खातों का प्रबंधन करें और पोर्टल में शिकायत गतिविधि जांचें।",
      "Citizen directory": "नागरिक निर्देशिका",
      "Active users with complaint summaries and account status.":
        "शिकायत सारांश और खाता स्थिति के साथ सक्रिय उपयोगकर्ता।",
      Name: "नाम",
      Email: "ईमेल",
      Phone: "फ़ोन",
      Location: "स्थान",
      ...
      Suspended: "निलंबित",
      "Submit complaints in your local language, get automated department routing, and track every grievance with live status updates.":
        "अपनी स्थानीय भाषा में शिकायत दर्ज करें, स्वचालित विभाग मार्गदर्शन पाएं, और प्रत्येक शिकायत को लाइव स्टेटस अपडेट के साथ ट्रैक करें।",
      "What makes this portal special?": "यह पोर्टल क्या खास बनाता है?",
      "Multi-language support": "बहु-भाषा समर्थन",
      "Speak in your own language and our chatbot will understand and register your grievance accurately.":
        "अपनी भाषा में बोलें और हमारा चैटबॉट आपकी शिकायत को सही ढंग से समझकर दर्ज करेगा।",
      "Real-time tracking": "रीयल-टाइम ट्रैकिंग",
      "Receive live updates and unique complaint numbers for every request you submit.":
        "सबमिट की गई प्रत्येक अनुरोध के लिए लाइव अपडेट और एक अद्वितीय शिकायत संख्या प्राप्त करें।",
      "One dashboard for all": "सभी के लिए एक डैशबोर्ड",
      "Citizens and admins can access a clean interface for grievance management and progress monitoring.":
        "नागरिक और एडमिन दोनों शिकायत प्रबंधन और प्रगति निगरानी के लिए साफ़ इंटरफ़ेस तक पहुँच सकते हैं।",
      ...
      "Use voice or text in your local language to tell the portal what problem you are facing.":
        "अपनी स्थानीय भाषा में वॉयस या टेक्स्ट का उपयोग करके पोर्टल को बताएं कि आप किस समस्या का सामना कर रहे हैं।",
      "The portal automatically matches the complaint to the right municipal department.":
        "पोर्टल स्वचालित रूप से शिकायत को सही नगरपालिका विभाग से जोड़ता है।",
      "Get updates and chat with support until your grievance is resolved.":
        "अपनी शिकायत के निपटारे तक अपडेट प्राप्त करें और सपोर्ट से चैट करें।",
      "Ready to improve citizen service delivery?":
        "नागरिक सेवा वितरण बेहतर करने के लिए तैयार?",
      "Build trust, reduce confusion, and speed up grievance resolution with a user-friendly AI-assisted grievance portal.":
        "एक उपयोगकर्ता-अनुकूल एआई-सहायता प्राप्त शिकायत पोर्टल के साथ विश्वास बनाएं, भ्रम कम करें, और शिकायत समाधान को तेज़ करें।",
      "Get Started": "शुरू करें",
      "Welcome back": "फिर से स्वागत है",
      "Sign in to lodge or track your grievance with ease.":
        "आसान तरीके से अपनी शिकायत दर्ज करने या ट्रैक करने के लिए साइन इन करें।",
      "Email Address": "ईमेल पता",
      Password: "पासवर्ड",
      "Remember Me": "मुझे याद रखें",
      "Forgot Password?": "पासवर्ड भूल गए?",
      "Create your account": "अपना खाता बनाएं",
      "Register as a citizen to lodge grievances and track updates easily.":
        "शिकायत दर्ज करने और अपडेट आसानी से ट्रैक करने के लिए नागरिक के रूप में पंजीकरण करें।",
      "Full Name": "पूरा नाम",
      ...
      Hindi: "हिंदी",
      Regional: "क्षेत्रीय",
      "Use the AI-assisted form to provide issue details and upload supporting media.":
        "समस्या विवरण प्रदान करने और सहायक मीडिया अपलोड करने के लिए एआई-सहायता प्राप्त फ़ॉर्म का उपयोग करें।",
      ...
      "or click to browse files (max 5MB).":
        "या फ़ाइल देखने के लिए क्लिक करें (अधिकतम 5MB)।",
      "Upload photo": "फ़ोटो अपलोड करें",
      "Submit Complaint": "शिकायत सबमिट करें",
      "Track your complaint": "अपनी शिकायत ट्रैक करें",
      "Follow the live progress of your grievance from lodging to resolution.":
        "अपनी शिकायत की लाइव प्रगति को दर्ज करने से समाधान तक ट्रैक करें।",
      ...
      "Your grievance has been successfully submitted and assigned an ID.":
        "आपकी शिकायत सफलतापूर्वक सबमिट की गई है और एक आईडी असाइन की गई है।",
      "The complaint content was analyzed and categorized for the correct department.":
        "शिकायत की सामग्री का विश्लेषण किया गया और सही विभाग के लिए वर्गीकृत किया गया।",
      "The complaint has been forwarded to the Water Supply department team.":
        "शिकायत को वॉटर सप्लाई विभाग टीम को अग्रेषित किया गया है।",
      "Field officers are currently reviewing the issue and scheduling resolution.":
        "फ़ील्ड अधिकारी वर्तमान में समस्या की समीक्षा कर रहे हैं और समाधान निर्धारित कर रहे हैं।",
      "The complaint will move to resolved once the field work is complete and verified.":
        "फ़ील्ड कार्य पूरा होने और सत्यापित होने पर शिकायत सुलझे हुए में चली जाएगी।",
      Completed: "पूरा किया गया",
      Ongoing: "चल रहा है",
      "Track Live Progress": "लाइव प्रगति ट्रैक करें",
      "Complaint Details": "शिकायत विवरण",
      "Review your grievance summary, AI assessment, and officer responses.":
        "अपनी शिकायत का सारांश, एआई आकलन, और अधिकारी की प्रतिक्रियाओं की समीक्षा करें।",
      ...
      "Inspection completed. Cleaning crew will clear the drain on the next working day.":
        "निरीक्षण पूरा हुआ। सफाई दल अगले कार्य दिवस पर नाली साफ़ करेगा।",
      "Concern escalated to the sanitation task force. Expected resolution by 2026-08-10.":
        "चिंता को स्वच्छता टास्क फोर्स को बढ़ाया गया। समाधान अपेक्षित 2026-08-10 तक।",
      High: "उच्च",
      ...
      "AI preview will update when you describe the issue in the box above.":
        "जब आप ऊपर बॉक्स में समस्या का वर्णन करेंगे तो एआई पूर्वावलोकन अपडेट हो जाएगा।",
      "Complaint history": "शिकायत इतिहास",
      "Review all grievances you have lodged and check their current status.":
        "उन सभी शिकायतों की समीक्षा करें जो आपने दर्ज की हैं और उनकी वर्तमान स्थिति जांचें।",
      "Search by complaint title or ID...":
        "शिकायत शीर्षक या आईडी द्वारा खोजें...",
      ...
      "Issues requiring immediate attention.":
        "तत्काल ध्यान की आवश्यकता वाले मुद्दे।",
      "Currently being handled across departments.":
        "वर्तमान में विभागों में संभाले जा रहे हैं।",
      ...
      "Update your account details, notification settings, and security preferences.":
        "अपने खाते का विवरण, अधिसूचना सेटिंग्स और सुरक्षा प्राथमिकताएं अपडेट करें।",
      ...
      "Request your grievance history export.":
        "अपनी शिकायत इतिहास निर्यात का अनुरोध करें।",
      "Temporarily suspend your profile.":
        "अस्थायी रूप से अपनी प्रोफ़ाइल निलंबित करें।",
      ...
      "Track Complaint": "शिकायत ट्रैक करें",
      "View All": "सभी देखें",
      "Sorry, the page you are looking for cannot be found. Please check the URL or return to the home page.":
        "क्षमा करें, जिस पेज को आप ढूंढ रहे हैं वह नहीं मिला। कृपया URL जांचें या होम पेज पर वापस जाएँ।",
      "Return to Home": "होम पर वापस जाएँ",
      "Oops! Something went wrong on our end. Please try again or return to the home page.":
        "उफ़! हमारी ओर से कुछ गलत हो गया। कृपया फिर से प्रयास करें या होम पेज पर वापस जाएँ।",
  ...
  const partialTranslations = [
    ...
    { prefix: "Assigned to ", hi: "सौंपा गया " },
    {
      prefix:
        "View department leads, active workloads, and pending complaint counts.",
      hi: "विभाग प्रमुखों, सक्रिय कार्यभार, और लंबित शिकायत गणना देखें।",
    },
    { prefix: "Assigned to ", hi: "सौंपा गया " },
  ...
  const pageTitleTranslations = {
    hi: {
      ...
      "Citizen Users – AI Grievance Portal":
        "नागरिक उपयोगकर्ता – एआई शिकायत पोर्टल",
      "Complaint Details – AI Grievance Portal":
        "शिकायत विवरण – एआई शिकायत पोर्टल",
      "Track Complaint – AI Grievance Portal":
        "शिकायत ट्रैक करें – एआई शिकायत पोर्टल",
      "Complaint View – AI Grievance Portal":
        "शिकायत दृश्य – एआई शिकायत पोर्टल",
      "Analytics – AI Grievance Portal": "एनालिटिक्स – एआई शिकायत पोर्टल",
      "Admin Dashboard – AI Grievance Portal":
        "एडमिन डैशबोर्ड – एआई शिकायत पोर्टल",
      "All Complaints — AI Grievance Portal":
        "सभी शिकायतें — एआई शिकायत पोर्टल",
      "All Complaints – AI Grievance Portal":
        "सभी शिकायतें – एआई शिकायत पोर्टल",
    },
  };
  ...
  function getPageTranslation(text, lang) {
    ...
    return (
      (pageTitleTranslations[lang] && pageTitleTranslations[lang][text]) || text
    );
  }
  ...
  function translateTextNode(textNode, lang) {
    const originalText =
      originalTextNodes.get(textNode) || textNode.textContent;
  ...
  (function attachLanguageOptionFallback() {
    ...
    languageOptionsFallback.forEach((btn) => {
      btn.addEventListener("click", function (e) {
        ...
        if (languageLabelEl)
          languageLabelEl.textContent = lang === "hi" ? "हिंदी" : "English";
